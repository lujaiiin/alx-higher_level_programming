...
class Test1(unittest.TestCase):
    ...
    def test6(self):
        """funtion"""
        self.assertEqual(max_integer([7, 6, 5, 4]), 7)
    ...
    def test9(self):
        """funtion"""
        self.assertEqual(max_integer([7, 2, 8, 6]), 8)
    ...
    def test11(self):
        """funtion"""
        self.assertEqual(
            max_integer([54, -78, 45, 68, -75, 47, -88, 222, 79, -754]),
            222)
        ...
        self.assertEqual(
            max_integer(
                [-6105619, -854849, -562553, -3088955, -6711290, -4817844,
                    ...
                    -2839083, -2586661, -9941097, -3136620, -2000]), -2000)

    def test14(self):
        """funtion"""
        self.assertEqual(
            max_integer(
                [130, 929.8, -1020, -0.1, 1314, 9999, -101234, 9456.9]), 9999)
    ...
    def tests(self):
        """funtion"""
        self.assertEqual(max_integer([[1], [2], [4], [2, 9]]), [4])
    ...
    def tesf(self):
        """Unittest"""
        self.assertEqual(max_integer([88, float('nan'), 555]), 555)

    def testq(self):
        """funtion"""
        with self.assertRaises(TypeError):
            max_integer([[], [2], [4], [5, 3], 75, "hi"])

    def testi(self):
        """funtion"""
        with self.assertRaises(TypeError):
            max_integer([55, "water"])
    ...
    def testl(self):
        """funtion"""
        with self.assertRaises(TypeError):
            max_integer([{5: 55, 14: 45}, {"water": "is good"}])
